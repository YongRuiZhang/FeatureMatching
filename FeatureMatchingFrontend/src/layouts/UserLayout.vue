            ...
            <el-container>
                <el-aside>
                    <el-menu class="el-menu-vertical-demo" :collapse="isCollapse" :ellipsis="false" router>
                        ...
                        <el-menu-item index="/user/detection">
                            <el-icon>
                                <SvgIcon iconName="icon-detection" />
                            </el-icon>
                            <template #title>特征检测记录</template>
                        </el-menu-item>

                        <el-menu-item index="/user/matching">
                            <el-icon>
                                <SvgIcon iconName="icon-icon_Matching" />
                            </el-icon>
                            <template #title>特征匹配记录</template>
                        </el-menu-item>

                        <el-menu-item index="/user/Mosaic">
                            <el-icon>
...
<script setup lang="ts" name="UserLayout">
import { ref } from 'vue'
